package pdf.allpdftoolsinoneplace.fragment;
...
import pdf.allpdftoolsinoneplace.R;
import pdf.allpdftoolsinoneplace.activity.FavouritesActivity;
import pdf.allpdftoolsinoneplace.activity.MainActivity;
import pdf.allpdftoolsinoneplace.customviews.MyCardView;
import pdf.allpdftoolsinoneplace.fragment.texttopdf.TextToPdfFragment;
import pdf.allpdftoolsinoneplace.model.HomePageItem;
import pdf.allpdftoolsinoneplace.util.CommonCodeUtils;

import static pdf.allpdftoolsinoneplace.util.Constants.ADD_IMAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_IMAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_PASSWORD_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_PWD;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_TEXT_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_WATERMARK;
import static pdf.allpdftoolsinoneplace.util.Constants.ADD_WATERMARK_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.BUNDLE_DATA;
import static pdf.allpdftoolsinoneplace.util.Constants.COMPRESS_PDF;
import static pdf.allpdftoolsinoneplace.util.Constants.COMPRESS_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.EXCEL_TO_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.EXTRACT_IMAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.EXTRACT_IMAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.EXTRACT_TEXT_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.HISTORY_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.IMAGE_TO_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.INVERT_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.MERGE_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.PDF_TO_IMAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.PDF_TO_IMAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.QR_BARCODE_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.REMOVE_PAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.REMOVE_PAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.REMOVE_PASSWORD_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.REMOVE_PWd;
import static pdf.allpdftoolsinoneplace.util.Constants.REORDER_PAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.REORDER_PAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.ROTATE_PAGES;
import static pdf.allpdftoolsinoneplace.util.Constants.ROTATE_PAGES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.SPLIT_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.TEXT_TO_PDF_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.VIEW_FILES_KEY;
import static pdf.allpdftoolsinoneplace.util.Constants.ZIP_TO_PDF_KEY;
