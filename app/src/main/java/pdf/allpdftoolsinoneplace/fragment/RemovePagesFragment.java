...
import pdf.allpdftoolsinoneplace.activity.RearrangePdfPages;
import pdf.allpdftoolsinoneplace.adapter.MergeFilesAdapter;
import pdf.allpdftoolsinoneplace.database.DatabaseHelper;
import pdf.allpdftoolsinoneplace.interfaces.BottomSheetPopulate;
import pdf.allpdftoolsinoneplace.interfaces.OnBackPressedInterface;
import pdf.allpdftoolsinoneplace.interfaces.OnPDFCompressedInterface;
import pdf.allpdftoolsinoneplace.interfaces.OnPdfReorderedInterface;
import pdf.allpdftoolsinoneplace.util.BottomSheetCallback;
import pdf.allpdftoolsinoneplace.util.BottomSheetUtils;
...
import pdf.allpdftoolsinoneplace.util.PDFEncryptionUtility;
import pdf.allpdftoolsinoneplace.util.PDFUtils;
import pdf.allpdftoolsinoneplace.util.RealPathUtil;
...
import static pdf.allpdftoolsinoneplace.util.FileUtils.getFormattedSize;
