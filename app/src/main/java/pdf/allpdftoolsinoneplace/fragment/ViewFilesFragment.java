...
import pdf.allpdftoolsinoneplace.adapter.ViewFilesAdapter;
import pdf.allpdftoolsinoneplace.interfaces.EmptyStateChangeListener;
import pdf.allpdftoolsinoneplace.interfaces.ItemSelectedListener;
import pdf.allpdftoolsinoneplace.util.DialogUtils;
import pdf.allpdftoolsinoneplace.util.DirectoryUtils;
import pdf.allpdftoolsinoneplace.util.FileSortUtils;
import pdf.allpdftoolsinoneplace.util.MergeHelper;
import pdf.allpdftoolsinoneplace.util.PermissionsUtils;
import pdf.allpdftoolsinoneplace.util.PopulateList;
...
import static pdf.allpdftoolsinoneplace.util.Constants.SORTING_INDEX;
